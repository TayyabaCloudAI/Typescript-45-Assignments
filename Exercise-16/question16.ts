...
let invite:string= (",I invite you to have dinner at my house tommorow night.");
...
let message: string = ",I invite you to have dinner at my house tonight, please come."

for(let i:number=0; i<guest.length; i++)
    {console.log(`Hello ${guest[i]} ${message}`)}
